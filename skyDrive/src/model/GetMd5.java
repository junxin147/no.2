...
//      }
    public static String MD5(String pwd) {
	        ...
	        try {
	          ...
	          md.update(pwd.getBytes());//2.传入需要计算的字符串更新摘要信息，传入的为字节数组byte[],将字符串转换为字节数组使用getBytes()方法完成
	        ...
	        //声明StringBuffer对象
	          ...
	          System.out.println("MD5(" + pwd + ",32) = " + result);//输出32位16进制字符串
//	          System.out.println("MD5(" + pwd + ",16) = " + buf.toString().substring(8, 24));//输出16位16进制字符串
